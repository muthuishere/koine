...
;; build.cljgo — cljgo
(defn build [b]
  (dep b "net.clojars.muthuishere/koine" {:mvn/version "0.7.1"})
...
> keep-alive.
>
> **Upgrade to `0.7.1`.** Measured twice, independently: 61.07s → 0.56s here,
...
**The API is unstable at `0.7.1`.** `koine.process`, `koine.route` and
